...
/**
 * Uniform scale from intro buddy box toward home hub box (height-limited: 380→240).
 * Used on /welcome while greeting fades in.
 */
export const INTRO_TO_HOME_BUDDY_SCALE = 240 / 380;

/** Home hub mascot — matches end state of welcome shrink */

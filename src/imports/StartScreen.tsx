...
export default function StartScreen() {
  return (
    <div className="bg-gradient-to-b from-[#ff9178] relative size-full to-[#ffc9bd]" data-name="Start Screen">
      ...
      <button className="-translate-x-1/2 absolute block cursor-pointer left-1/2 size-[376px] top-[348px]" data-name="red bud 2">
